...
interface CalendarEvent {
  ...
  allDay: boolean;
  resource: WorkspaceScheduleItem;
}

interface WorkspaceScheduleCalendarProps {
  items: WorkspaceScheduleItem[];
  onEventClick?: (item: WorkspaceScheduleItem) => void;
}

export function WorkspaceScheduleCalendar({
  items,
  onEventClick,
}: WorkspaceScheduleCalendarProps) {
