...
## 9) Pull Requests / Commits (guidelines)

* Commits pequenos por feature
* PRs com:

  * contexto (milestone + task id do PRD)
  * checklist do que foi testado
  * screenshots (quando UI)
* Nunca misturar refactor grande com feature (separar PR)

---

## 10) O que NÃO fazer (anti-patterns)

* Adicionar libs de UI/componentes “framework” sem necessidade
* Criar um “mega domínio” antes do MVP
* Inventar analytics complexos
* Implementar permissão multi-user completa no MVP
* Mudar fórmulas de viabilidade (server-side deve seg
